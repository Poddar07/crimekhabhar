		...
		<section class="section">
					...
					<?php foreach ( $child_terms as $child_term ) : ?>
						...
						<section class="subcategory-block">
							...
							<div class="subcategory-head">
								<h2>
									<a href="<?php echo esc_url( get_category_link( $child_term ) ); ?>">
							...
							<?php else : ?>
								...
								<p class="empty-state">
									<?php esc_html_e( 'No posts yet in this subcategory.', 'bharat-bulletin' ); ?>
								</p>
			...
			<?php else : ?>
				...
				<?php else : ?>
					...
					<p class="empty-state">
						<?php esc_html_e( 'No posts found in this subcategory.', 'bharat-bulletin' ); ?>
					</p>
